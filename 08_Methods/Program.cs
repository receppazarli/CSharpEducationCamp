...
namespace _08_Methods
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            #region Geriye Değer Döndüren Strig Parametreli Metotlar
            ...
            //Console.WriteLine(Sum(43, 62));
            //Console.WriteLine(Sum(14, 26));
            //Console.WriteLine(Sum(48, 62));
            //Console.WriteLine(Sum(14, 36));
